...
| warning (주의) | `#fff3db` | `#ffe0a3` | **`#9e6a00`** | `#8a5c00` | `#2e1f00` |
| success (완료) | `#eaf6ec` | `#d8eedd` | **`#228738`** | — | — |
| information (안내) | `#e7f4fe` | `#d3ebfd` | **`#0b78cb`** | `#096ab3` | `#03253f` |

주의색만 조심 — 널리 알려진 노랑 `#ffb114` 은 **30단계**이고, 기준(50)은
어두운 호박색 `#9e6a00` 입니다. 노랑은 글자색으로 쓰면 대비가 안 나오니
**칠하는 색**으로만 쓰고, 글자에는 `text-warning`(60단계 `#8a5c00`)을 씁니다.
