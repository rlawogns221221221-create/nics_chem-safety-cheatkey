...
**`…_사용설명서.pdf` (A4 4쪽)** — **거의 그림입니다.** 실제 화면 사진에
①②③ 을 박아 어디를 누르는지 표시했고, 글은 낱말만 답니다.
1쪽 접속 주소와 도구 세 가지, 2쪽 방제 물품·장비 찾기, 3쪽 주민 대피장소
찾기, 4쪽 주민대피 문자생성기 — **도구별로 한 쪽씩**입니다.
개선 의견·오류를 보낼 곳도 적혀 있습니다.
