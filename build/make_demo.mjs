/* 시연 영상 만들기 — 실제 화면을 눌러 가며 녹화합니다
   ...
   ── 배경지도에 대하여 ─────────────────────────────────────────
   이 개발 환경은 바깥으로 못 나가서 **배경지도 타일을 못 받습니다.**
   실제 배포 주소에서는 도로·건물이 나옵니다. 없는 것을 있는 것처럼
   그리지 않고, 그 사실을 **자막으로 밝힙니다**(설명서 사진과 같은 원칙).
   ─────────────────────────────────────────────────────────── */
...
/* 배경지도 경고 띠는 이 환경에서만 뜨는 것이라 가리고, 대신 자막으로 밝힙니다 */
...
await 자막('※ 녹화 환경에서는 배경지도 타일을 받지 못해 경계선만 보입니다 — 실제 화면에는 도로·건물이 함께 나옵니다', 3600);
